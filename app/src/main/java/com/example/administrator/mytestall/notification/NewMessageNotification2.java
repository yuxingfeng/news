...
/**
 * Helper class for showing and canceling new message2
 * notifications.
 * <p>
...
public class NewMessageNotification2 {
     ...
     * presentation of new message2 notifications. Make
     * sure to follow the
    ...
    public static void notify(final Context context,
        ...
        final String title = res.getString(
                R.string.new_message2_notification_title_template, exampleString);
        final String text = res.getString(
                R.string.new_message2_notification_placeholder_text_template, exampleString);
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setSmallIcon(R.drawable.ic_stat_new_message2)
