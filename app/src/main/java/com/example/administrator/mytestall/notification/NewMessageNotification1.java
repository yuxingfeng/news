...
/**
 * Helper class for showing and canceling new message1
 * notifications.
 * <p>
 * This class makes heavy use of the {@link NotificationCompat.Builder} helper
 * class to create notifications in a backward-compatible way.
 */
public class NewMessageNotification1 {
    /**
     * The unique identifier for this type of notification.
     */
    private static final String NOTIFICATION_TAG = "NewMessage1";
     ...
     * presentation of new message1 notifications. Make
     * sure to follow the
    ...
    public static void notify(final Context context,
        ...
        final String title = res.getString(
                R.string.new_message1_notification_title_template, exampleString);
        final String text = res.getString(
                R.string.new_message1_notification_placeholder_text_template, exampleString);
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setSmallIcon(R.drawable.ic_stat_new_message1)
